...
<head>
  ...
  <link rel="icon" href="assets/images/gunadarma.png" type="image/ico" />

  <title> Data kelas 3KA09 | Universitas Gunadarma </title>
    ...
    <div class="main_container">
        ...
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <center>
              &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span>
                  <font size="4.95" color="white" face="Helvetica Neue">Data Kelas 3KA09</font>
                </span></a>
            </center>
          </div>
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="assets/images/verdy.jpg" alt="..." class="img-circle profile_img">
            </div>
            <div class="profile_info">
              <span>Welcome,</span>
              <h2>Verdyan Rachmad Wirathama</h2>
            </div>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-desktop"></i> Jadwal Kuliah <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="#">Tampil Data</a></li>
                    <li><a href="#">Tambah Data</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-gear"></i> Settings <span class="fa fa-chevron"></span></a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open">
                <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/verdy.jpg" alt="">Verdyan Rachmad Wirathama
                </a>
      ...
      <footer>
        <div class="pull-right">
          Copyright @ 2021 Akademik 3KA09 : Kelompok 2
        </div>
        <div class="clearfix"></div>
      </footer>
    </div>
